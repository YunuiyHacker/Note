package yunuiy_hacker.ryzhaya_tetenka.feature.favorites.presentation
...
@Composable
fun FavoritesScreen(
    onClickItem: (Int) -> Unit, viewModel: MainViewModel = hiltViewModel()
) {
    ...
    Scaffold(snackbarHost = {
        ...
        TopAppBar(
            title = { Text(text = "Избранное", fontFamily = ubuntu, color = Primary) },
            navigationIcon = {
                Icon(
            ...
            when (result) {
                ...
                is Response.Success -> {
                    ...
                    if (favorites.isEmpty()) {
                        ...
                        NoteList(modifier = Modifier.padding(horizontal = 12.dp),
                            notes = favorites,
